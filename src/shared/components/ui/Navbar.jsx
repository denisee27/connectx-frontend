          ...
          <div className="flex items-center gap-4">
            ...
            {!isAuthenticated && (
              <button
                ...
                className="cursor-pointer inline-flex items-center gap-2 rounded-full bg-primary px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors duration-200 hover:bg-secondary focus:outline-none focus:ring-2 focus:ring-red-400"
              >
                Sign In
              </button>
            )}
    ...
    >
      ...
      <div className="absolute inset-0 grid place-items-center p-4">
        ...
        >
          ...
          <p className="mt-1 text-sm text-muted-foreground">Are you sure you want to log out?</p>
          ...
          <div className="mt-4 flex items-center justify-end gap-3">
            ...
            <button
              type="button"
              onClick={onConfirm}
              className="cursor-pointer rounded-full bg-red-500 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-red-600"
            >
              Logout
            </button>
          </div>
