                            ...
                            <form onSubmit={handleSubmit} className="mt-4 space-y-4">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-xs text-gray-500">
                                        Recommended minimum resolution: {MIN_IMAGE_WIDTH}×{MIN_IMAGE_HEIGHT} (landscape). Max size: {MAX_IMAGE_SIZE_MB}MB.
                                    </p>
                                    {errors.imageFile && (
                                ...
                                <div>
                                    ...
                                    {errors.cityId && (
                                        <p className="mt-1 text-xs text-red-600">{errors.cityId}</p>
                                    )}
                                </div>
                    ...
                    <div className="mx-auto max-w-3xl px-4">
                        <div className="flex items-start gap-2 rounded-3xl border border-border bg-card p-2 shadow-lg transition-all duration-200">
                            ...
                            <button
                                type="button"
                                onClick={handleSend}
                                className="hover:cursor-pointer inline-flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-accent text-black shadow-sm transition-colors hover:bg-primary"
                                aria-label="Send"
                            >
                                <Send size={18} />
                            </button>
