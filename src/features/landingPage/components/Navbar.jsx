                    ...
                    <div className="flex items-center justify-end">
                        {user ? (
                            ...
                            <div className="flex items-center gap-2 sm:gap-4">
                                ...
                                {!isAuthenticated && (
                                    <button onClick={() => navigate("/login")} className="rounded-xl px-4 py-2 bg-transparent border-2 border-black text-black font-semibold hover:bg-black hover:text-white cursor-pointer transition-all duration-150 text-sm" >
                                        Sign In
                                    </button>
                                )}
